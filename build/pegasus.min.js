...
var Pegasus = function Pegasus(_ref) {
	...
	if (router) return new PegasusRouter({ config: config, defaultRoute: defaultRoute, baseURL: baseURL, $container: $container });else return new PegasusHasher({ config: config, defaultRoute: defaultRoute, $container: $container });
};
...
var PegasusRouter = function () {
	function PegasusRouter(_ref5) {
		var config = _ref5.config,
		    defaultRoute = _ref5.defaultRoute,
	...
	_createClass(PegasusRouter, [{
		key: "saddle",
		value: function saddle(elements) {
			var _this5 = this;
		...
		value: function dieOrlive(currentRoute) {
			...
			if ($element != undefined) {
				if (this.isHTMLElement($element.$element)) this.$container.appendChild($element.$element);else this.$container.innerHTML += $element.$element;
			} else {
